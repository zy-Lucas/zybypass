...
void ZHeap::initialize()
{
    ...
    page_allocator_offset = *type->get_field_offset("_page_allocator");
    page_table_offset = *type->get_field_offset("_page_table");
    forwarding_table_offset = *type->get_field_offset("_forwarding_table");
    relocate_offset = *type->get_field_offset("_relocate");
}
} // namespace hotspot::gc::z