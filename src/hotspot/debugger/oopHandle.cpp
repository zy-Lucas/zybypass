...
void OopHandle::write_compressed_klass_address_at(uint64_t offset, OopHandle handle) const noexcept
{
    runtime::Jvm::write_compressed_klass_address_value(address() + offset, handle.address());
}
